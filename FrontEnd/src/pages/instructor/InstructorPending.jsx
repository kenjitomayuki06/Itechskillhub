...
const InstructorRegister = () => {
  ...
  const strengthClass = ['', 'str-weak', 'str-weak', 'str-fair', 'str-good', 'str-strong'][pwStrength];
      ...
      <div className="reg-card">
        ...
        <form onSubmit={handleRegister} className="reg-form" noValidate>
          ...
          <div className="reg-field">
            <label htmlFor="reg-code">Invite Code</label>
            <div className="reg-input-wrap">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <rect x="3" y="11" width="18" height="11" rx="2"/>
                <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
              </svg>
              <input id="reg-code" type="text" name="inviteCode"
                value={formData.inviteCode} onChange={handleChange} onBlur={handleBlur}
                placeholder="ITECH-XXXXXXXX" autoComplete="off" />
            </div>
            <p className="reg-pw-hint">
              <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <circle cx="12" cy="12" r="10"/>
                <line x1="12" y1="8" x2="12" y2="8"/>
                <line x1="12" y1="12" x2="12" y2="16"/>
              </svg>
              Contact the admin to get your invite code.
            </p>
          </div>
