    import { getCourseProgressQuery } from "../../database/coursesQueries/courseProgressQuery.js"; // Adjust based on your actual db import
    ...
    export async function getCourseProgressController(req,res) {
        try {
            ...
            if (rows.length === 0) { 
                ...
                const responseData = {
                    courseCompletion: `${progressPercentage}%`,
